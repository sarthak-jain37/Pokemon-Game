...
public class Move {
    ...
    public Move(String name, Type type, int basePower, Category category, StatModifier statModifier, StatusEffect effect, Target target, int pp, int accuracy) {
        this.name = name;
        this.type = type;
    ...
    public void setAdvantage(List<Type> opponentTypes) {
        this.advantage = 1;
        for (Type opponentType : opponentTypes) {
            switch (this.type) {
                case FIRE ->
